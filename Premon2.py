...
def main():
    ...
    st.sidebar.info("This webapp monitors the presence of operators in a smart factory"
    ...
    if selected_menu == 'Operator Validation':
        ...
        if img_file_buffer is not None:
            ...
            ## Saving operator History
            with open(os.path.join(OPERATORS_HISTORY,
                                   f'{operator_id}.jpg'), 'wb') as file:
    ...
    if selected_menu == 'Add to Database':
        ...
        if ((img_file_buffer is not None) & (len(face_name) > 1) &
            ...
            with open(os.path.join(OPERATORS_DB,
